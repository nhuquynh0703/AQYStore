        ...
        <form method="post" action="?modules=users&controllers=index&action=infoUpdate" name="form-checkout">
            <div class="section" id="customer-info-wp">
                ...
                <div class="section-detail">
                    ...
                    <div class="form-row clearfix">
                        <div class="form-col fl-left">
                            ...
                            <input style="height: 38px; width: 250px; border: 1px solid #cccccc;" type="email"
                                   name="mail" id="email" value="<?php echo isset($_SESSION['mail']) ? $_SESSION['mail'] : ''; ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-row clearfix">
                        <div class="form-col fl-left">
                            ...
                            <input style="height: 38px; width: 250px; border: 1px solid #cccccc;" type="text"
                                   name="phone" id="phone" value="<?php echo isset($_SESSION['phone']) ? $_SESSION['phone'] : ''; ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-row clearfix">
                        <div class="form-col fl-left">
                            ...
                            <input style="height: 38px; width: 250px; border: 1px solid #cccccc;" type="text"
                                   name="address" id="address" value="<?php echo isset($_SESSION['address']) ? $_SESSION['address'] : ''; ?>" readonly>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-row clearfix" style="margin-top: 20px;">
                    <input type="submit" name="btn_update" value="Cập nhật" style="padding: 10px 20px; background: green; color: #fff; border: none; border-radius: 4px;">
                </div>
            </div>
        </form>
