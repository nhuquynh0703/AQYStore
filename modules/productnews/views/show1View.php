            ...
            <div class="section" id="paging-wp">
                <div class="section-detail">
                    <ul class="list-item clearfix">
                        ...
                        <li>
                            <a <?php if($i == $data['5']) echo 'style="background-color: green;"';  ?>  href="?modules=products&controllers=index&action=show1&id_cat=<?php echo($data['3']) ; ?>&page=<?php echo $i; ?>" title=""><?php echo $i; ?></a>
                        </li>
                        <?php }; ?>
                    </ul>
                </div>
