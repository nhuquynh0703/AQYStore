                    ...
                    <ul id="main-menu" class="fl-left">
                        ...
                        <li>
                            ...
                            <ul class="sub-menu">
                                ...
                                <li>
                                    <a href="?modules=brands&controllers=index&action=list" title="">Thương hiệu sản
                                        phẩm</a>
                                </li>
                                <li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu">
                                <li>
                                    <a href="?modules=orders&controllers=index&action=listNo" title="">Đơn hàng cần xử
                                        lý</a>
                                </li>
                                <li>
                        ...
                        <li>
                            <a href="?page=list_post" title="">Khách hàng</a>
                            <ul class="sub-menu">
                                <li>
                                    <a href="?modules=customers&controllers=index&action=list" title="">Danh sách khách
                                        hàng</a>
                                </li>
                            </ul>
                    ...
                    <div id="dropdown-user" class="dropdown dropdown-extended fl-right">
                        <button class="dropdown-toggle clearfix" type="button" data-toggle="dropdown"
                            ...
                            <div id="thumb-circle" class="fl-left"
                                style="border-radius: 100px; background-color: white;">
                                <img style="max-width: 46px; max-height: 46px;border-radius: 46px;"
                                    src="public/images/home-icon.png">
                            </div>
                            <h3 id="account" class="fl-right"><?php echo $_SESSION['fullname'] ;?></h3>
                        </button>
                        <ul class="dropdown-menu">
                            <li><a href="?modules=users&controller=index&action=info" title="Thông tin cá nhân">Thông
                                    tin tài khoản</a></li>
                            <li><a href="?modules=users&controller=index&action=logout" title="Thoát">Đăng xuất</a></li>
                        </ul>
                    </div>
                </div>
            </div>